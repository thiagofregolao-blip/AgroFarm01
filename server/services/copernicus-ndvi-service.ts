...
// High-contrast NDVI palette — 21 stops (every 0.05) for maximum intra-field variation
...
function evaluatePixel(sample) {
  ...
  return valueInterpolate(ndvi,
    [-0.2, 0.0, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 1.0],
    [
      [0.40, 0.40, 0.40, 1],
      [0.60, 0.00, 0.10, 1],
      [0.80, 0.10, 0.10, 1],
...
// Agronomic NDVI — green-only scale with fine gradation
